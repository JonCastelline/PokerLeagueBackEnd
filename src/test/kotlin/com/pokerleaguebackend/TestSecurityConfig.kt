...
class TestSecurityConfig {
    ...
    fun userDetailsService(): UserDetailsService {
        ...
        val ownerPrincipal = UserPrincipal(ownerAccount)
        ...
        val adminPrincipal = UserPrincipal(adminAccount)
        ...
        val playerPrincipal = UserPrincipal(playerAccount)
        ...
        val creatorPrincipal = UserPrincipal(creatorAccount)
        ...
        val joinerPrincipal = UserPrincipal(joinerAccount)
        ...
        val testUserPrincipal = UserPrincipal(testUserAccount)
        ...
        val nonMemberPrincipal = UserPrincipal(nonMemberAccount)
